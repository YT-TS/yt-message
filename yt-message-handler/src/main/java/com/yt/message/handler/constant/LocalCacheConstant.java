...
public class LocalCacheConstant {
    ...
    public static final int PLATFORM_CACHE_INITIAL_CAPACITY  = 5;
    public static final int PLATFORM_CACHE_MAXIMUM_CAPACITY  = 20;
    public static final Duration PLATFORM_CACHE_EXPIRE_TIME = Duration.ofDays(3);

    public static final int TEMPLATE_CACHE_INITIAL_CAPACITY  = 5;
