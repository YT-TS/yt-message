...
import com.yt.message.stream.common.config.RocketMQConfigBuilder;
import com.yt.message.stream.source.enumstate.offset.OffsetsSelector;
import com.yt.message.stream.source.enumstate.offset.OffsetsSelectorNoStopping;
...
import static com.yt.message.stream.source.RocketMQSourceOptions.SOURCE_CONFIG_VALIDATOR;
...
public class RocketMQSourceBuilder<OUT> {
    ...
    public RocketMQSourceBuilder<OUT> setPullThreadNums(Integer pullThreadNums) {
        this.configBuilder.set(RocketMQSourceOptions.PULL_THREAD_NUM, pullThreadNums);
        return this;
    }
