...
import com.yt.message.stream.common.config.RocketMQConfigValidator;
import com.yt.message.stream.common.config.RocketMQOptions;
import com.yt.message.stream.legacy.RocketMQConfig;
...
public class RocketMQSourceOptions extends RocketMQOptions {
    ...
    // pull message limit
    public static final ConfigOption<Integer> PULL_THREAD_NUM =
